...
<head>
    ...
    <style>
        body {
            /* Black to white gradient, fading right to left */
            background: linear-gradient(to left, #fff 0%, #222 100%);
            min-height: 100vh;
...
<body>
    <div class="container d-flex flex-column justify-content-center align-items-center min-vh-100">
        <div class="welcome-card p-5 text-center">
            ...
            <h1 class="mb-3">Welcome to OptiWear</h1>
        ...
        <div class="footer text-center mt-4">
            &copy; {{ date('Y') }} OptiWear Supply Management
        </div>
    </div>
</body>