...
<body class="bg-light-bg dark:bg-dark-bg text-light-text dark:text-dark-text min-h-screen flex flex-col">
    ...
    <header class="w-full py-4 px-6 lg:px-8 bg-white dark:bg-dark-card shadow-sm">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <nav class="flex items-center gap-4">
                @auth
                <<<<<<< HEAD <a href="{{ url('/dashboard') }}"
                    class="px-4 py-2 rounded-md border border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                    Dashboard
                    =======
                    <<<<<<< HEAD <a href="{{ url('/dashboard') }}"
                        ...
                        <a href="{{ route('register') }}"
                            class="px-4 py-2 rounded-md bg-primary-light dark:bg-primary-dark text-white hover:bg-opacity-90 transition">
                            Register
                        </a>
                        @endif
                        @endauth
    ...
    <main class="flex-grow flex items-center justify-center p-6 lg:p-8">
        <div class="w-full max-w-4xl flex flex-col-reverse lg:flex-row gap-6">
            <!-- Content card -->
            <div
                class="flex-1 p-6 text-4xl font-bold text-gray-700 dark:text-gray-300 opacity-30 lg:p-10 bg-light-card dark:bg-dark-card rounded-lg shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                G-20
            </div>

            <!-- Image/illustration placeholder -->
            <div
                class="w-full lg:w-1/2 bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900 dark:to-purple-900 rounded-lg overflow-hidden relative min-h-[300px] lg:min-h-[400px]">
