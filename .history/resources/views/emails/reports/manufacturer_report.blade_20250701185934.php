...
<x-mail::panel>
    ...
    <ul>
        <li>Ensure all raw materials are checked for quality upon delivery.</li>
        <li>Follow up on any pending orders to avoid production delays.</li>
        <li>Maintain accurate records of all transactions for future reference.</li>
    </ul>
<x-mail::button :url="''">
View Report
</x-mail::button>
