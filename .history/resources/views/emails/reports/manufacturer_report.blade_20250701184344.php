...
<h1>Hello {{ $user->name }},</h1><p> Here is your weekly raw materials purchase report for this week of {{ $date }}.
    ...
    Please review the attached report for detailed information on your purchases.</p>
