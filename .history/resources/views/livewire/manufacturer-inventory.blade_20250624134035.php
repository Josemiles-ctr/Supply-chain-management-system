        ...
        <form wire:submit.prevent="placeOrder">
            ...
            <div class="space-y-4">
                ...
                <div>
                 ...
                 <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Qunatyity at $ {{$rawmaterial_price}} per @each('view.name', $collection, 'variable', 'view.empty')</label>
                    <input type="number"
