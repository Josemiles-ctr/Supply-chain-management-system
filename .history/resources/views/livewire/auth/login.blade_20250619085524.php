<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 via-white to-zinc-200 dark:from-zinc-900 dark:via-zinc-800 dark:to-zinc-900">
    <div class="w-full max-w-md bg-white/80 dark:bg-zinc-900/80 rounded-3xl shadow-2xl p-8 sm:p-10 border border-zinc-200 dark:border-zinc-800 backdrop-blur-md">
        <div class="flex flex-col gap-6">
            <!-- Logo/Avatar -->
            <div class="flex justify-center mb-2">
                <img src="/logo.png" alt="Logo" class="h-14 w-14 rounded-full shadow-lg border-2 border-blue-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 object-cover" />
            </div>
            <!-- Header with reduced margin-bottom -->
            <div class="mb-2">
            ...
            <form wire:submit="login" class="flex flex-col gap-6">
                ...
                <flux:input
                    ...
                    class="rounded-xl shadow focus:ring-2 focus:ring-blue-400 bg-blue-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700"
                />
                ...
                <div class="flex items-center justify-end">
                    <flux:button variant="primary" type="submit" class="w-full py-3 rounded-xl text-base font-semibold shadow-lg bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white transition-all duration-200">
                        {{ __('Log in') }}
                    </flux:button>
                </div>
            </form>
