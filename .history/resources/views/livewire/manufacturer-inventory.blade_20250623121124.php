        ...
        @foreach($rawmaterials as $rawmaterial)
          ...
          @endphp
              ...
              <td class="px-6 py-4">
                  ...
                  <button class="bg-green-600 text-white px-4 py-2 cursor-pointer rounded hover:bg-green-700 transition"
                  @click="openEditModal({ 
                    id: {{ $rawmaterial->id }},
                    name: '{{ $rawmaterial->name }}',
                    quantity: '{{ $rawmaterial->reorder_level }}',
                    message: 'Requesting reorder for {{ $rawmaterial->name }}'
                  })" 
