    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 bg-white border-separate border-spacing-0 rounded-lg overflow-hidden">
      <thead class="text-xs uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
        <tr>
          ...
          <th scope="col" class="ps-0 py-3 text-left">Color</th>
          <th scope="col" class="ps-0 py-3 text-left">Category</th>
          <th scope="col" class="ps-0 py-3 text-left">Price</th>
          <th scope="col" class="ps-5 py-3 text-left">Action</th>
        </tr>
      </thead>
      <tbody>
