                ...
                <div wire:click='selectUser({{ $user->id }})' class="p-3 cursor-pointer hover:bg-blue-100 transition 
                    ...
                    <div class="flex items-center justify-center text-gray-800 ">
                        <div class="flex items-center gap-3 justify-start w-full">
                            <span class="inline-flex items-center justify-center rounded-full border-2 border-[#84c1dd] bg-white shadow flex-shrink-0" style="aspect-ratio:1/1; width:2.25rem; min-width:2.25rem; max-width:100%; margin-right:0.75rem;">
