        ...
        <form wire:submit.prevent="placeOrder">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" live:model='rawmaterial_name' value="{{$rawmaterial_name}}" readonly
                ...
                <div>
                    ...
                    <input type="text" value="{{ $rawmaterial_category }} {{$rawmaterial->category_id}}" readonly
                           class="mt-1 w-full px-4 py-2 border border-gray-300 dark:border-gray-600 
                                  text-black dark:text-white bg-white dark:bg-gray-800 rounded-lg focus:ring-blue-500 focus:border-blue-500" />
                </div>
