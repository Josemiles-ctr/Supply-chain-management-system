    ...
    <div class="bg-white dark:bg-gray-900 w-full max-w-lg rounded-xl shadow-lg p-6 relative">
        ...
        <form wire:submit.prevent="placeOrder">
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label name="category" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Category</label>
                ...
                <div>
                    ...
                    <input name="name" type="text" wire:mode='rawmaterial_name' value="{{$rawmaterial_name}" readonly
                           class="mt-1 w-full px-4 py-2 border border-gray-300 dark:border-gray-600 
                                  text-black dark:text-white bg-white dark:bg-gray-800 rounded-lg focus:ring-blue-500 focus:border-blue-500" />
                </div>

                <div>
                    <label name="message" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Quantity in {{$unit_of_measure}}</label>
                    <input type="number" value="50" wire:model.defer="rawmaterial_quantity" min="1"  
                           class="mt-1 w-full px-4 py-2 border border-gray-300 dark:border-gray-600 
                                  text-black dark:text-white bg-white dark:bg-gray-800 rounded-lg focus:ring-blue-500 focus:border-blue-500" />
                </div>
