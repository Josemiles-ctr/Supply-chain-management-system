        ...
        @foreach($rawmaterials as $rawmaterial)
          ...
          @endphp
              ...
              <td class="px-6 py-4">
                  ...
                  <button wire:click="select_rawmaterial({{$rawmaterial->id}}" @click="$nextTick(() => open = 'openedit')" class="bg-green-600 text-white px-4 py-2 cursor-pointer rounded hover:bg-green-700 transition">
                    Re Order Now
                  </button>
