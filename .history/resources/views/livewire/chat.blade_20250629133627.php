            ...
            <div class="p-4 space-y-2">
                ...
                @foreach($messages as $message)
                    <div class="flex {{ $message->sender_id === Auth::id() ? 'justify-end' : 'justify-start' }}">
                        <div {{ $message->sender_id === Auth::id() ? 'style="background-color: #1a7a06 !important; color: white !important; border-radius: 2rem !important; padding: 0.5rem 1rem !important; font-size: 0.875rem !important; font-weight: 600 !important;"' : 'bg-blue-600 text-white dark:bg-blue-700' }} class="max-w-xs px-4 py-2 rounded-2xl shadow {{ $message->sender_id === Auth::id() ? 'bg-gray-500 text-white dark:bg-gray-700' : 'bg-blue-600 text-' }}">
                            {{ $message->message }}
