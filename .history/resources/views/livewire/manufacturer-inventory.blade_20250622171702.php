      ...
      <tbody>
        @foreach($rawmaterials as $rawmaterial)
          <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            $reorder = $rawmaterial->reoder_level;
          
            if ($stock > $reorder && $stock <= $reorder + 10) {
          ...
          @endphp
              ...
              <td class="px-6 py-4">
                  <div class="flex items-center">
                      <div class="h-2.5 w-2.5 rounded-full {{$styles}} me-2"></div>{{$status}}
                  </div>
              </td>
              <td class="px-6 py-4">
                  <!-- Modal toggle -->

                  <button @click="open = 'openedit'" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">
                    Re Order Now
                  </button>

                  <a @click="open = 'openedit'" href="#" type="button" data-modal-target="editUserModal" data-modal-show="editUserModal" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Re Order Now</a>
              </td>
          </tr>
          @endforeach
      </tbody>
