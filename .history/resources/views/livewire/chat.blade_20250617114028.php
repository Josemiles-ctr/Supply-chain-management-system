            ...
            <div class="divide-y flex-1 overflow-y-auto">
                ...
                <div class="flex items-center justify-center text-gray-800 ">
                    <div class="flex items-center gap-3 justify-start w-full">
                        <svg style="width: 36px; height: 36px; border-radius: 50%; box-shadow: 0 2px 8px rgba(0,0,0,0.12); border: 2px solid #3bf68f; background: #fff; padding: 6px;" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
