    ...
    <div class="flex h-[550px] text-sm border rounded-xl shadow overflow-hidden bg-white">
        ...
        <div class="w-3/4 flex flex-col">
            ...
            <div class="flex-1 p-4 overflow-y-auto space-y-2 bg-gray-50">
                ...
                <div class="flex {{$sender_id===Auth::id() ? 'justify-end' : 'justify-start'}} ">
                    <div class="max-w-xs px-4 py-2 rounded-2xl shadow {{$sender_id===Auth::id() ? 'justify-end' : 'justify-start'}} bg-blue-600 text-white">
                        {{ $message->message }}
                    </div>
                </div>
                @endforeach
