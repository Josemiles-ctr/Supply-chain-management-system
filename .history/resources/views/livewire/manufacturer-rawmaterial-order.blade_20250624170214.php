        ...
        <tbody>
          ...
          <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <td class="px-6 py-4">
             ...
             <td>
              <form wire:submit="cancerOrder({{$order->id}})" method="POST" onsubmit="return confirm('Are you sure you want to cancel this order?');">
                <button type="submit" class="bg-red-400 text-white px-4 py-2 cursor-pointer hover:bg-red-700 transition rounded">
                    Cancel Order
                </button>
            </form>
