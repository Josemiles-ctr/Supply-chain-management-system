    ...
    <div class="bg-white dark:bg-gray-900 w-full max-w-lg rounded-xl shadow-lg p-6 relative">
        ...
        <form wire:submit.prevent="placeOrder">
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label name="quantity" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Quantity in {{$unit_of_measure}}</label>
                    <input wire:change='calculateTotal' type="number" wire:model='rawmaterial_quantity'
                           class="mt-1 w-full px-4 py-2 border border-gray-300 dark:border-gray-600 
                                  text-black dark:text-white bg-white dark:bg-gray-800 rounded-lg focus:ring-blue-500 focus:border-blue-500" />
                </div>
                ...
                <div>
                    <label name="total" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Total Price</label>
                    <input type="numbe wire:model='total' value="$ {{$total}}"
                           class="mt-1 w-full px-4 py-2 border border-gray-300 dark:border-gray-600 
                                  text-black dark:text-white bg-white dark:bg-gray-800 rounded-lg focus:ring-blue-500 focus:border-blue-500" />
                </div>
