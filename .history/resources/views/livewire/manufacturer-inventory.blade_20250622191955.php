...
<div class="relative overflow-x-auto rounded-lg shadow-md">
  ...
  <!-- Dark Background -->
  <div class="fixed inset-0 bg-black/30 backdrop-blur-sm z-50 bg-opacity-50 pointer-events-auto"></div>
  ...
  <div @click.away="open = false"
    ...
    <h2 class="text-xl font-semibold text-gray-800 mb-4">Place Raw Material Purchase Order</h2>

    <form @submit.prevent="alert('Form submitted!'); open = false;" @click.stop>
      @csrf
      <div class="space-y-4">
        <!-- Name Field -->
        <div class="max-w-full mx-auto">
