    ...
    <div class="bg-white dark:bg-gray-900 w-full max-w-lg rounded-xl shadow-lg p-6 relative">
        ...
        <form wire:submit.prevent="placeOrder">
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label name="message" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Quantity in {{$unit_of_measure=='pieces' ? $unit_of_measure : $unit_of_measure''' }}</label>
