      ...
      <form @submit.prevent="alert('Form submitted!'); open = false;">
        ...
        <div class="relative w-full">
          <input 
            ...
            id="name" 
            placeholder=" " 
            class="peer w-full border border-gray-300 rounded-md px-4 pt-6 pb-2 text-sm placeholder-transparent focus:outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600"
          />
          <label 
            for="name" 
            class="absolute left-4 top-2 text-gray-500 text-sm transition-all peer-placeholder-shown:top-3.5 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-focus:top-2 peer-focus:text-sm peer-focus:text-blue-600"
          >
            Full Name
          </label>
        </div>
