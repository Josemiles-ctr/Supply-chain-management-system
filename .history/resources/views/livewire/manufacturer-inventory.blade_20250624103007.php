                           ...
                           <div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <label class="flex items-center p-3 border rounded-lg cursor-pointer transition-all 
                                              hover:border-blue-500 focus-within:ring-2 focus-within:ring-blue-400
                                              dark:border-gray-600 dark:hover:border-blue-400">
                                    <input type="radio" wire:model="delivery_option" value="pickup"
                                           class="form-radio text-blue-600 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-600">
                                    <span class="ml-3 text-sm text-gray-800 dark:text-gray-100">Pickup</span>
                                </label>
                                ...
                                <label class="flex items-center p-3 border rounded-lg cursor-pointer transition-all 
                                              hover:border-blue-500 focus-within:ring-2 focus-within:ring-blue-400
                                              dark:border-gray-600 dark:hover:border-blue-400">
                                    <input type="radio" wire:model="delivery_option" value="delivery"
                                           class="form-radio text-blue-600 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-600">
                                    <span class="ml-3 text-sm text-gray-800 dark:text-gray-100">Delivery</span>
                                </label>
                            </div>
                        
                            <div class="mt-2 text-sm text-gray-600 dark:text-gray-300">
                                Selected: <strong>{{ ucfirst($delivery_option) }}</strong>
                            </div>
                        </div>
