          ...
          <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            $styles= [
             ...
             $statements=[
              ...
              <td class="px-6 py-4">
                  <!-- Modal toggle -->
                  <a @click="open = 'openedit'" href="#" type="button" data-modal-target="editUserModal" data-modal-show="editUserModal" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Reo</a>
              </td>
          </tr>
      </tbody>
  </table>
