                    ...
                    <div class="flex {{ $message->sender_id === Auth::id() ? 'justify-end' : 'justify-start' }}">
                        <div 
                            @if($message->sender_id === Auth::id())
                                style="background-color: #1a7a06 !important; color: white !important; border-radius: 2 !important; padding: 0.5rem 1rem !important; font-size: 0.875rem !important; font-weight: 600 !important;"
