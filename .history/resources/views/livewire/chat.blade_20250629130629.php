    ...
    <div class="flex-1 bg-gray-50 dark:bg-gray-900 overflow-y-auto">
        ...
        @endif
                ...
                @csrf
                    ...
                    <button type="submit"
                    style="background-color: #1a7a06 !important; cursor: pointer !important; color: white !important; border-radius:  !important; padding: 0.5rem 1rem !important; font-size: 0.875rem !important; font-weight: 600 !important;"
