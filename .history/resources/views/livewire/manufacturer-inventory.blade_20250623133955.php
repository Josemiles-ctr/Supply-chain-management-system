<div x-data="{ open: false }" class="relative">
  ...
  <div class="p-6 flex justify-end">
    <button @click="$nextTick(() => open = 'openedit')"
        ...
        @foreach($rawmaterials as $rawmaterial)
          ...
          @endphp
              ...
              <td class="px-6 py-4">
                  ...
                  <button wire:click='select_rawmaterial({{$rawmaterial->id}})' @click="open = 'openedit'" class="bg-green-600 text-white px-4 py-2 cursor-pointer rounded hover:bg-green-700 transition">
                    Re Order Now
                  </button>
...
<div 
  ...
  <!-- Overlay: blocks interaction and adds blur/dim -->
      <div 
        ...
        <!-- Modal Content -->
      <div class="relative z-50 bg-white dark:bg-gray-900 w-full max-w-lg rounded-xl shadow-lg p-6"
                @click.away="open = false"
                @keydown.escape.window="open = false">
    <!-- Modal Header -->
          <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-4">Re Order {{$rawmaterial_name ?? "Unknown product name"}} Now</h2>
