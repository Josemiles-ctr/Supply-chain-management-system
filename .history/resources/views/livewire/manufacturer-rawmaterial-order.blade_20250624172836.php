         ...
         <td class="px-6 py-4 {{ $statusColor }}">
             ...
             <td>
              @if($order->status == 'pending')
                <button wire:click="cancelOrder({{$order->id}})" onclick="confirm('Are you sure you want to cancel this order?') || event.stopImmediatePropagation()" class="bg-red-400 text-white px-4 py-2 cursor-pointer hover:bg-red-700 transition rounded">
                    Cancel Order
                </button>
