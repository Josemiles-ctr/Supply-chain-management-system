                ...
                <div wire:click='selectUser({{ $user->id }})' class="p-3 cursor-pointer hover:bg-blue-100 transition 
                    ...
                    <div class="flex items-center justify-between text-gray-800">
                        <div class="flex items-center w-full">
                            <!-- Fixed-width container for icon with fixed left padding -->
                            <span class="inline-flex items-center justify-center rounded-full border-2 border-[#84c1dd] bg-white shadow flex-shrink-0"
                                  style="aspect-ratio:1/1; width:2.25rem; min-width:2.25rem; max-width:2.25rem; margin-left:1rem; margin-right:0.75rem;">
