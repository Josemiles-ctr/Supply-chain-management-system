...
>
    <div class="filament-page px-0 py-0 !bg-transparent">
        <div class="chat-component flex h-[550px] text-sm border rounded-xl shadow overflow-hidden bg-green-200">
            <div class="w-1/4 border-r bg-green-200 flex flex-col">
            ...
            <div class="w-3/4 flex flex-col">
                ...
                <div class="p-4 border-b bg-gray-50 flex items-center gap-4">
                    ...
                    <div>
                        <div class="text-lg font-semibold text-gray-800">{{$selectedUser->name ?? 'No user'}}</div>
