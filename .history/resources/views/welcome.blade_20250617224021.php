...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-light-bg dark:bg-dark-bg text-light-text dark:text-dark-text min-h-screen flex flex-col">
        ...
        <main class="flex-grow flex items-center justify-center p-6 lg:p-8">
            <div class="w-full max-w-4xl flex flex-col-reverse lg:w-1/2 bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900 dark:to-purple-900 lg:flex-row gap-6">
                <!-- Content card -->
