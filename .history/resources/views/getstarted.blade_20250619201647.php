    ...
    <div class="relative max-w-3xl w-full mx-auto text-center p-10 bg-white/90 dark:bg-gray-900/90 shadow-2xl rounded-3xl border border-blue-200 dark:border-gray-700 overflow-hidden">
        ...
        <style>
            @media (min-width: 768px) {
                .max-w-3xl {
                    max-width: 30rem !important; /* Further reduced from 38rem */
                }
                .custom-min-h {
                    min-height: 16rem !important; /* Further reduced min-height */
                    max-height: 22rem !important; /* Further reduced max-height */
                }
            }
            .max-w-3xl {
