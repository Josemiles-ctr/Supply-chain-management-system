            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Actions')" class="grid">
                   ...
                   //Conditional Navigation items accessible to only Manufacturer and Supplier roles
                    ...
                    <flux:navlist.item icon="truck" :href="route('manufacturer-inventory')" :current="request()->routeIs('manufacturer-inventory')" wire:navigate>{{ __('Manage Orders') }}</flux:navlist.item>
