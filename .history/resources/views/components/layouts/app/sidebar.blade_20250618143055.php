        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Actions')" class="grid">
                    ...
                    <flux:navlist.item icon="chat-bubble-oval-left-ellipsis" :href="route('place-order')" :current="request()->routeIs('place-order')" wire:navigate>{{ __('Place Order') }}</flux:navlist.item>
