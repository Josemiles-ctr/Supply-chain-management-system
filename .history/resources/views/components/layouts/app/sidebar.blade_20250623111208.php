            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Actions')" class="grid">
                   ...
                   {{-- //Conditional Navigation items accessible to only Manufacturer and Supplier roles --}}
                    ...
                    <flux:navlist.item icon="shopping-cart" :href="route('manufacturer-rawmaterial-orders')" :current="request()->routeIs('manufacturer-rawmaterial-orders')" wire:navigate>{{ __('Manage Rawmaterial Orders') }}</flux:navlist.item>
                    @endif
                    @if(Auth::User()->role=='supplier')
                    <flux:navlist.item icon="shopping-cart" :href="route('supplier-rawmaterial-orders'')" :current="request()->routeIs('rawmaterial-orders')" wire:navigate>{{ __('Manage Orders') }}</flux:navlist.item>
                    @endif
                </flux:navlist.group>
            </flux:navlist>
