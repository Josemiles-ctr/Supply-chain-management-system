            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Actions')" class="grid">
                   ...
                   {{-- //Conditional Navigation items accessible to only Manufacturer and Supplier roles --}}
                    ...
                    <flux:navlist.item icon="shopping-cart" :href="route(''rawmaterial-orders'')" :current="request()->routeIs('rawmaterial-orders')" wire:navigate>{{ __('Manage Orders') }}</flux:navlist.item>
                    @endif
                </flux:navlist.group>
            </flux:navlist>
