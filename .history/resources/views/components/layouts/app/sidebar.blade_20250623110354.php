            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Actions')" class="grid">
                   ...
                   {{-- //Conditional Navigation items accessible to only Manufacturer and Supplier roles --}}
                    ...
                    <flux:navlist.item icon="shopping-cart" :href="route('manufacturer-rawmaterial-orders')" :current="request()->routeIs('manufacturer-rawmaterials')" wire:navigate>{{ __('Manage Rawmaterials') }}</flux:navlist.item>
                    @endif
