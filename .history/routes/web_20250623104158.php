...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/dashboard/orders', ManufacturerInventory::class)->name('manufacturer-inventory');
    Route:get('/dashboard/orders', RawmaterialOrders::class)->name('rawmaterial-orders');
});
