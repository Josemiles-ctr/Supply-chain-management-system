...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/dashboard/manufacturer-rawmaterial', ManufacturerInventory::class)->name('manufacturer-rawmaterial');
    //Route::get('/dashboard/inventory', Inventory::class)->name('inventory');
