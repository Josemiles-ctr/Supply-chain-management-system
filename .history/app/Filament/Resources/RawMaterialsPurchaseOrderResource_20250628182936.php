        ...
        return $form
            ->schema([
                ...
                TextInput::make('price_per_unit')
                    ...
                    ->numeric()
                    ->readonly()
                    ->visible(fn ($get) => !empty($get('rawMaterial_id')))
                    ->dehydrated(fn ($get) => !empty($get('rawMaterial_id')))
                    ->default(fn ($get) => 
                        !empty($get('rawMaterial_id')) 
                            ? RawMaterial::find($get('rawMaterial_id'))?->price ?? null 
                            : null
                    )
                    ->visible(fn ($get) => !empty($get('rawMaterial_id')))
                    ->dehydrated(fn ($get) => !empty($get('rawMaterial_id'))),
