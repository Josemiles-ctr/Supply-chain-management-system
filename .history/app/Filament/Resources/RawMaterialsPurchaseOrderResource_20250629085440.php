...
public static function beforeCreate(Form $form, $record): void
{
    ...
    $record->order_date = now()->format('Y-m-d');
    $record->expected_delivery_date = now()->addDays(3)->format('Y-m-d');
}
            ...
            ->schema([
                ...
                TextInput::make('total_price')
                    ...
                    ->afterStateUpdated(function ($state, callable $set) {
                        ...
                        $set('total_price', $quantity * $pricePerUnit);
                    })
            ]);
    }
