    ...
    public function calculateTotal()
{
    ...
    public function updateStockLevel(){
        ...
        $this->dispatch('order-placed', message: ' placed successfully!');
        
    } catch (\Exception $e) {
        $this->dispatch('Oops Failed to place order. Pleaseproide all the neessary fields. Consider Reporting if this problem persists ');
    }
}
