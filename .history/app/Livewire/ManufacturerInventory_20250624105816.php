    ...
    public function calculateTotal()
{
    ...
    public function placeOrder()
    {
        $purchase_order= RawMaterialsPurchaseOrder::create([
            ...
            'expected_delivery_date'=> now()->addDays()->format('Y-m-d')
            'notes'=>
            'delivery_option'=>
            'total_price'=>
            'created_by'=>
        ...
        $this->reset(['rawmaterial_quantity','delivery_option', 'rawmaterial_message','rawmaterial_quantity','unit_of_measure', 'showModal']);
