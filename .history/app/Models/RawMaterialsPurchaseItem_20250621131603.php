...
class RawMaterialsPurchaseItem extends Model
{
   protected $fillable = [
    ...
    {
        return number_format($this->purchaseOrder ? $this->purchaseOrder->price_per_unit : 0, 2);
    }
    public function getFormattedQuantityAttribute()
    {
        return number_format($this->purchaseOrder ? $this->purchaseOrder->quantity : 0);
    }
    public function getStatusLabelAttribute()
    {
        return $this->purchaseOrder ? $this->purchaseOrder->getStatusLabelAttribute() : 'Unknown Status';
    }
   public function getFormattedExpectedDeliveryDateAttribute()
    {
        return $this->purchaseOrder ? $this->purchaseOrder->getFormattedExpectedDeliveryDateAttribute() : 'N/A';
    }
}