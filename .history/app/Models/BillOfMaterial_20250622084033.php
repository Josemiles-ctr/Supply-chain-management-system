...
class BillOfMaterial extends Model
{
    protected $fillable = [
        'product_id',
        'raw_material_id',
        'quantity', // Quantity of raw material needed for the product
    ];
    ...
    public function getProductReorderLevelAttribute()
    {
        return $this->product ? $this->product->reorder_level : 0;
    }
   
    public function getProductProductionCostAttribute()
    {
        return $this->product ? $this->product->production_cost : 0;
    }
}