...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('raw_materials_purchase_orders', function (Blueprint $table) {
            ...
            $table->decimal('price_per_unit', 10, 2);  Total price for the order
            ...
            $table->enum('delivery_option', ['standard', 'express'])->default('standard'); // Delivery option for the order
            $table->decimal('expected_quantity', 10, 2); // Expected quantity of raw material
