...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('raw_materials_purchase_orders', function (Blueprint $table) {
            ...
            $table->enum('delivery_opt', ['standard', 'express'])->default('standard'); // Delivery option for the order
$table->enum('payment_status', ['pending', 'paid', 'partially_paid'])->default('pending'); // Payment status of the order
            $table->enum('payment_method', ['cash', 'credit_card', 'bank_transfer'])->default('cash'); // Payment method used for the order
